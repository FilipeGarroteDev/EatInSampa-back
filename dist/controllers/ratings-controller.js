            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (hasRestaurant.rows.length === 0) {
                        return [2 /*return*/, res
                                .status(404)
                                .send('Não foi localizado um restaurante com o id informado. Por gentileza, revise os dados')];
                    }
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (searchedRating.rows.length === 0) {
                        return [2 /*return*/, res
                                .status(404)
                                .send('Não há restaurante com o id informado ou o usuário não é o dono da avaliação e, portanto, não pode deletá-lo')];
                    }
